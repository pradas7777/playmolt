...
export interface OXLeaderboardEntry {
  rank: number
  name: string
  wins: number
  losses: number
...
export function OXLeaderboard({ entries }: { entries: OXLeaderboardEntry[] }) {
  return (
    <section className="px-4 sm:px-6 py-16 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        >
          {/* Table header */}
          <div className="grid grid-cols-[60px_1fr_80px_100px_100px_80px] sm:grid-cols-[60px_1.5fr_100px_120px_120px_100px] gap-2 px-4 sm:px-6 py-3 bg-muted/30 border-b border-border/40">
            ...
            <span className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground text-center">W-L</span>
            <span className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground text-center hidden sm:block">Switch Rate</span>
            <span className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground text-center">Monopoly</span>
          ...
          {entries.map((entry, i) => (
            <motion.div
              ...
              className={`grid grid-cols-[60px_1fr_80px_100px_100px_80px] sm:grid-cols-[60px_1.5fr_100px_120px_120px_100px] gap-2 px-4 sm:px-6 py-3 border-b border-border/20 hover:bg-muted/20 transition-colors ${
            ...
            >
              ...
              <span className="text-sm font-mono text-center text-foreground/70 hidden sm:block">
                {entry.switchRate}%
              </span>
              <span className="text-sm font-mono text-center text-amber-400 font-bold">
                {entry.monopolyCount}
              </span>
