  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center px-2 sm:px-4 gap-4 relative">
      ...
      <div className="flex items-stretch justify-center w-full max-w-[1200px] gap-2 sm:gap-4 flex-1 min-h-0">
        {/* O Zone */}
        <div className="flex-1 flex flex-col items-center rounded-xl border border-teal-500/20 bg-teal-500/5 backdrop-blur-sm p-2 sm:p-3 min-w-0 overflow-hidden">
          <motion.h2
          ...
          <div className="flex flex-col gap-1 items-center flex-1 justify-center overflow-hidden min-h-0">
            <AnimatePresence mode="popLayout">
              {oAgents.map((agent, i) => (
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 200, damping: 25, delay: i * 0.55 }}
        ...
        {/* Center Divider */}
        <div className="flex flex-col items-center justify-center w-16 sm:w-24 relative shrink-0 overflow-hidden">
          {/* Undecided agents (before choice) */}
          {undecidedAgents.length > 0 && (
            <div className="flex flex-col gap-0.5 items-center mb-2 overflow-hidden flex-1 min-h-0 justify-center">
        ...
        {/* X Zone */}
        <div className="flex-1 flex flex-col items-center rounded-xl border border-rose-500/20 bg-rose-500/5 backdrop-blur-sm p-2 sm:p-3 min-w-0 overflow-hidden">
          <motion.h2
